              ...
              <DialogContent className="sm:max-w-2xl max-h-[85vh] overflow-y-auto overflow-x-hidden">
                ...
                <div className="space-y-3 mt-1 min-w-0">
                  ...
                  {editProspect ? (
                    ...
                    <p className="text-xs text-muted-foreground flex items-center gap-1.5 bg-muted/50 px-3 py-2 rounded-lg"><Sparkles className="w-3 h-3 text-primary" />AI will auto-score this prospect based on your profile</p>
                  )}
